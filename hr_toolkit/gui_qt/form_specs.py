...
SPECS: tuple[ToolUiSpec, ...] = (
    ToolUiSpec(
        ...
        "请选择社保缴费清单和参保人员花名册，然后点击“生成报表”。结果会保存在当前项目，源文件请自行保管。",
    ...
    ToolUiSpec(
        ...
        "请选择保单人员清单和人力资源分析表，然后点击“生成台账”。结果会保存在当前项目，源文件请自行保管。",
    ...
    ToolUiSpec(
        ...
        "请选择考勤结果、周报记录和月报记录，然后点击“生成统计”。应汇报人员名单是可选项，结果会保存在当前项目，源文件请自行保管。",
    ...
    ToolUiSpec(
        ...
        "请选择工资表文件，然后点击“开始拆分”。结果会保存在当前项目，源文件请自行保管。",
    ...
    ToolUiSpec(
        ...
        "请选择工资表文件、压缩包或文件夹，然后点击“开始合并”。已有汇总表是可选项，结果会保存在当前项目，源文件请自行保管。",
    ...
    ToolUiSpec(
        ...
        "请选择异动表文件或文件夹，然后点击“开始汇总”。已有汇总表是可选项，结果会保存在当前项目，源文件请自行保管。",
    ...
    ToolUiSpec(
        ...
        "请选择异动汇总表和人力资源花名册，然后点击“更新花名册”。结果会保存在当前项目，源文件请自行保管。",
    ...
    ToolUiSpec(
        ...
        "选择员工资料库路径（只读扫描）", "开始打包",
        "请选择员工资料库根目录，输入目标人员或选择员工名单 Excel，勾选所需材料类型，然后点击“开始打包”。",
        input_mode="directory_single", support_id="roster_source", support_label="员工名单 Excel（可选）",
    ...
    ToolUiSpec(
        ...
        fields=(
            ...
            {"id": "source_column", "kind": "text", "label": "原文件名列（可选）", "default": "原文件名", "placeholder": "留空使用“原文件名”列"},
            {"id": "target_column", "kind": "text", "label": "新名称列（可选）", "default": "新名称", "placeholder": "留空使用“新名称”列"},
